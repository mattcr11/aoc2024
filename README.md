...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `135.9µs` | `168.6µs` |
| [Day 2](./src/bin/02.rs) | `164.3µs` | `201.6µs` |
| [Day 3](./src/bin/03.rs) | `49.7µs` | `58.3µs` |
| [Day 4](./src/bin/04.rs) | `2.8ms` | `2.9ms` |
| [Day 5](./src/bin/05.rs) | `1.6ms` | `2.6ms` |
